...
/**
 * This is the item provider adapter for a {@link hiphops.BasicEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BasicEventItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BasicEvent_defaultString_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BasicEvent_defaultString_feature", "_UI_BasicEvent_type"),
				 HiphopsPackage.Literals.BASIC_EVENT__DEFAULT_STRING,
				 true,
				 false,
				 false,
