 ...
 * @generated
 */
public class SystemTest extends DescribedClassTest {
	 ...
	 */
	@Override
	protected hiphops.System getFixture() {
		return (hiphops.System)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(HiphopsFactory.eINSTANCE.createSystem());
	}
